...
name1="2014"
infolder1="HET/pbo_lssq_NA/"
infolder2="HET/nmt_lssq_NA/"
infolder3="HET/pbo_nldas_NA/"
infolder4="HET/pbo_nldas_scaled_NA/"
infolder5="HET/pbo_lsdm_NA/"
# infolder6="HET/pbo_lssq_NA/"
...
latS=39
latN=42.5
output1=$name1"_HET_comparison.ps"
...
gmt makecpt -T-21/21/1 -Ic -CBlueWhiteOrangeRed > datacpt.cpt  # this is for the 2014 case
gmt makecpt -T-21/21/1 -CBlueWhiteOrangeRed > scalecpt.cpt  # this is for the 2016 case
...
-124.2 $label_lat A: PBO LSSQ HET
EOF
...
gmt pstext -R$range -J$projection -F+f18p,Helvetica -Gwhite -K -O <<EOF >> $output1
-121.55 $label_lat $name1
-124.2 $label_lat B: NMT LSSQ HET
EOF
...
gmt pstext -R$range -J$projection -F+f18p,Helvetica -Gwhite -K -O <<EOF >> $output1
-121.55 $label_lat $name1
-124.2 $label_lat C: PBO NLDAS HET
EOF
...
-121.55 42.0 $name1
-123.7 $label_lat D: PBO NLDAS SCALED HET
EOF
...
gmt pstext -R$range -J$projection -F+f18p,Helvetica -Gwhite -K -O <<EOF >> $output1
-121.55 $label_lat $name1
-124.2 $label_lat E: PBO LSDM HET
EOF
...
gmt psscale -R$range -J$projection -DjTR+w6c/0.5c+o-1.5/0.2 -Cscalecpt.cpt -B5.0:"":/:mm/yr: -P -O >> $output1
