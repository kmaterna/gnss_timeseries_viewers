...
single_station_tsplot.view_single_station(station, offsets_remove=1, earthquakes_remove=0,
                                          outliers_remove=1, seasonals_remove=1, outliers_def=15, seasonals_type='lssq',
                                          datasource='cwu', refframe='NA', data_config_file=data_config_file,
                                          outdir="");
