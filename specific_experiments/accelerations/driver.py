...
filter_type='nldas_scaled'; # OPTIONS: lssq, notch, stl, grace, gldas, nldas, shasta, oroville, none. 
size='huge';  # OPTIONS: small, medium, huge
network='pbo';  # choices: unr, pbo, cwu, nmt, nldas, gldas, noah025
refname='NA'; # choices: NA, ITRF
stations=["CPUD"];  # In case you only want to do a few stations manually. 
