...
awk '{print $2, $3}' medrange.txt | gmt psxy -R$range -J$projection -Sc0.02 -Gdarkorchid1 -K -O -P >> $output2
awk '{print $2, $3}' deeprange.txt | gmt psxy -R$range -J$projection -Sc0.02 -Gdarkorange1 -K -O -P >> $output2
