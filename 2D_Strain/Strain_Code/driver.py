...
def driver_1d(strain_method):
	...
	common_io_functions.outputs_1d(xdata, ydata, polygon_vertices, I2nd, max_shear, rot, e1, e2, v00, v01, v10, v11, dilatation, myVelfield, MyParams);	
	return;
...
def driver_2d(strain_method):
	...
	common_io_functions.outputs_2d(xdata, ydata, I2nd, max_shear, rot, e1, e2, v00, v01, v10, v11, dilatation, myVelfield, MyParams);	
	return;
...
if __name__=="__main__":
	...
	# Doesn't work right now, and similar to Hammond anyway
